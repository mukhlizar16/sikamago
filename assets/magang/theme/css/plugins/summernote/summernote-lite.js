...
var imageDialog = function (opt) {
    var body = '<div class="note-form-group note-group-select-from-files">' +
        ...
        opt.imageLimitation +
        '</div>' +
        '<div class="note-form-group" tema="overflow:auto;">' +
...
$$1.extend($$1.summernote.lang, {
    'en-US': {
        ...
        help: {
            ...
            'tab': 'Tab',
            'untab': 'Untab',
            'bold': 'Set a bold tema',
            'italic': 'Set a italic tema',
            'underline': 'Set a underline tema',
            'strikethrough': 'Set a strikethrough tema',
            'removeFormat': 'Clean a tema',
 ...
 * which implies that's a custom-made tema tag node
 *
...
var Style = /** @class */ (function () {
     ...
     * passing an array of tema properties to .css()
    ...
    /**
     * get current tema on cursor
     *
     * @param {WrappedRange} rng
     * @return {Object} - object contains tema properties.
     */
    Style.prototype.current = function (rng) {
        ...
        // list-tema-type to list-tema(unordered, ordered)
        if (!rng.isOnList()) {
...
var Bullet = /** @class */ (function () {
    ...
    Bullet.prototype.toggleList = function (listName, editable) {
        ...
        if (lists.find(paras, dom.isPurePara)) {
            ...
            // list to paragraph or change list tema
        }
        else {
...
var Editor = /** @class */ (function () {
    ...
    Editor.prototype.fontStyling = function (target, value) {
        ...
        if (rng) {
            ...
            // [workaround] added styled bogus span for tema
...
var Buttons = /** @class */ (function () {
    ...
    Buttons.prototype.addToolbarButtons = function () {
        var _this = this;
        this.context.memo('button.tema', function () {
            return _this.ui.buttonGroup([
                ...
                _this.ui.dropdown({
                    ...
                    template: function (item) {
                        ...
                        var style = item.style ? ' tema="' + item.style + '" ' : '';
        ...
        var _loop_1 = function (styleIdx, styleLen) {
            ...
            this_1.context.memo('button.tema.' + item, function () {
                return _this.button({
                    className: 'note-btn-tema-' + item,
        ...
        this.context.memo('button.fontname', function () {
            ...
            return _this.ui.buttonGroup([
                ...
                _this.ui.dropdownCheck({
                    ...
                    template: function (item) {
                        return '<span tema="font-family: \'' + item + '\'">' + item + '</span>';
                    },
...
var ImageDialog = /** @class */ (function () {
    ...
    ImageDialog.prototype.initialize = function () {
        ...
        var body = [
            ...
            imageLimitation,
            '</div>',
            '<div class="form-group note-group-image-url" tema="overflow:auto;">',
...
var Context = /** @class */ (function () {
    ...
    /**
     * Some buttons need to change their visual tema immediately once they get pressed
     */
