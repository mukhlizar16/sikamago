					...
					<div class="card-body">
						<div class="row">
							<div class="form-group col-md-6 col-12">
								<label>Jalan</label>
								<input type="text" class="form-control" value="<?= $profil['jln'] ?>" readonly>
							</div>
							<div class="form-group col-md-6 col-12">
								<label>Desa</label>
						...
						<div class="row">
							<div class="form-group col-md-6 col-12">
								...
								<input type="text" class="form-control" value="<?= $profil['kec'] ?>" readonly>
							</div>
							<div class="form-group col-md-6 col-12">
								<label>Kabupaten</label>
								<input type="text" class="form-control" value="<?= $profil['kab'] ?>" readonly>
							</div>
						</div>
						<div class="row">
							<div class="form-group col-md-6 col-12">
								<label>Provinsi</label>
								<input type="text" class="form-control" value="<?= $profil['prov'] ?>" readonly>
							</div>
						</div>
					</div>
					<div class="card-footer text-right">
						<a href="<?= site_url('kkn/profil/edit') ?>" class="btn btn-primary"><i class="fas fa-edit fa-fw"></i> Edit</a>
					</div>
				</div>
				<div class="card">
					<div class="card-header">
					...
					<div class="card-body">
						<div class="row">
							<div class="form-group col-md-6 col-12">
								...
								<input type="text" class="form-control" value="<?= $profil['nama_ayah'] ?>" readonly>
							</div>
							<div class="form-group col-md-6 col-12">
								<label>Nama Ibu</label>
								<input type="text" class="form-control" value="<?= $profil['nama_ibu'] ?>" readonly>
							</div>
						</div>
						<div class="row">
							<div class="form-group col-md-6 col-12">
								<label>No HP Ayah</label>
								<input type="text" class="form-control" value="<?= $profil['hp_ayah'] ?>" readonly>
							</div>
							<div class="form-group col-md-6 col-12">
								<label>No HP Ibu</label>
								<input type="text" class="form-control" value="<?= $profil['hp_ibu'] ?>" readonly>
							</div>
						</div>
						<div class="row">
							<div class="form-group col-md-6 col-12">
								<label>Jalan</label>
								<input type="text" class="form-control" value="<?= $profil['jln_ortu'] ?>" readonly>
							</div>
							<div class="form-group col-md-6 col-12">
								<label>Desa</label>
								<input type="text" class="form-control" value="<?= $profil['desa_ortu'] ?>" readonly>
							</div>
						</div>
						<div class="row">
							<div class="form-group col-md-6 col-12">
								<label>Kecamatan</label>
								<input type="text" class="form-control" value="<?= $profil['kec_ortu'] ?>" readonly>
							</div>
							<div class="form-group col-md-6 col-12">
								<label>Kabupaten</label>
								<input type="text" class="form-control" value="<?= $profil['kab_ortu'] ?>" readonly>
							</div>
						</div>
						<div class="row">
							<div class="form-group col-md-6 col-12">
