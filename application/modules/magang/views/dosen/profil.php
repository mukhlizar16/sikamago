	...
	<div class="pcoded-content">
		...
		<div class="row">
					...
					<div class="tab-pane fade show active" id="personal" role="tabpanel" aria-labelledby="home-tab">
						<div class="card">
							...
							<div class="card-body border-top pro-det-edit collapse" id="pro-det-edit-2">
								<form method="post" action="<?= site_url('magang/dosen/update_profil_pa_C1') ?>"
									  id="form-dosen-tabus">
									<div class="form-group row">
										<label class="col-sm-3 col-form-label font-weight-bolder">Nama Depan</label>
										<div class="col-sm-9">
						...
						<div class="card">
							...
							<div class="card-body border-top pro-dont-edit collapse " id="pro-dont-edit-2">
								<form id="form-tabDosen" action="<?= site_url('magang/dosen/update_profil_pa_C2') ?>"
									  method="post">
									<div class="form-group row">
			...
			<div class="col-md-4 order-1">
						...
						<ul class="list-inline">
							<?php foreach ($bimbingan->result_array() as $m) : ?>
								<li class="list-inline-item">
									<a
									<!--href="<? /*= site_url('dosen/detail_mahasiswa') */ ?>/--><? /*= $m['idm'] */ ?>
									">
									<img src="<?= base_url() ?>assets/magang/userfiles/<?= $m['foto'] ?>" alt="user image"
										 class="img-radius mb-2 wid-50" data-toggle="tooltip"
										 data-original-title="<?= $m['napan'] . ' ' . $m['nabel'] ?>">
									</a>
								</li>
							<?php endforeach; ?>
						</ul>
				...
				<div class="card">
					<div class="card-header d-flex align-items-center justify-content-between">
						<h5 class="mb-0">Mahasiswa Bimbingan Artikel</h5>
						<span class="badge badge-light-primary float-right"><?= $artikel->num_rows(); ?>+</span>
					</div>
					<div class="card-body">
						<ul class="list-inline">
							<?php foreach ($artikel->result_array() as $a) : ?>
								<li class="list-inline-item">
									<a data-toggle="tooltip" data-placement="top"
									   title="<?= $a['napan'] . ' ' . $a['nabel'] ?>">
									<img src="<?= base_url() ?>assets/magang/userfiles/<?= $a['foto'] ?>" alt="user image"
										 class="img-radius mb-2 wid-50">
									</a>
								</li>
							<?php endforeach; ?>
						</ul>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="form-uploadDosenFoto" action="<?= site_url('dosen/update_foto_pa') ?>" method="post">
