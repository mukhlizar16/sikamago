			...
			<div class="col-sm-12">
				<div class="card">
					...
					<div class="card-header">
						<h5><?= anchor('magang/dosen/pesan', 'Pesan') ?> / Detil Pesan</h5>
					...
					<div class="card-body">
						<table id="tabel-dosen-balas-pesan" class="table table-hover dataTable nowrap table-responsive">
							<thead>
							<tr>
							...
							foreach ($pesan->result_array() as $p) : ?>
								<tr>
									...
									<td class="text-center">
										<?php
										if($p['status'] == 0) {	?>
											<button type="button" id="btn-baca" class="btn btn-sm btn-primary" data_id="<?= $p['id_pesan'] ?>" data-toggle="tooltip" data-placement="top" title="tandai sudah baca">
												<i class="feather icon-check-circle"></i>
											</button>
										<?php }else{ ?>
											<button type="button" id="btn-belum-baca" class="btn btn-sm btn-warning" data_id="<?= $p['id_pesan'] ?>" data-toggle="tooltip" title="tandai sudah baca">
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					...
					<!-- konten -->
					<div class="card-body">
						<form action="<?= site_url('magang/dosen/balas_pesan') ?>" method="post" id="dosen-balas-pesan">
