			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="mt-3 collapse col-md-8" id="form-add">
							<form action="<?= site_url('admin/add_pengumuman') ?>" method="post" id="form-add-pengumuman">
								<div class="form-group fill row">
										<label class="col-form-label col-md-3 text-right" for="">Judul :</label>
									<div class="col-md-9">
										<input type="text" name="judul" id="judul" class="form-control">
									</div>
								</div>
								<div class="form-group fill row">
									<label class="col-form-label col-md-3 text-right" for="">Deskripsi :</label>
									<div class="col-md-9">
			...
			<div class="col-md-12">
				<div class="card card-border-c-blue">
					<div class="card-body">
						...
						<div class="mt-3">
							<table class="table table-borderless table-responsive-xl" id="tabel-list-pengumuman">
								<thead>
								<tr>
									<th>Judul</th>
									<th>Deskripsi</th>
