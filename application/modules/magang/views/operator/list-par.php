			...
			<div class="col-sm-12">
				<div class="card">
					...
					<div class="card-header">
						<h5>Daftar Dosen Pembimbing Artikel Ilmiah</h5>
					...
					<div class="card-body">
						...
						<ul class="nav nav-pills mb-3" id="myTab" role="tablist" style="float: right">
							...
							<li class="nav-item">
								<a class="nav-link has-ripple" id="pills-tidak-aktif-tab" data-toggle="pill" href="#tidak-aktif" role="tab" aria-controls="tidak-aktif" aria-selected="false">
									Tidak Aktif
									<span class="badge badge-danger badge-pill"><?= belum_aktif(3) ?></span>
								</a>
							</li>
						</ul>
						...
						<div class="tab-content mt-3" id="myTabContent">
							<div class="tab-pane fade show active" id="aktif" role="tabpanel" aria-labelledby="aktif-tab">
								<table id="tabel-par-aktif" class="table table-striped dataTable nowrap table-responsive-lg">
									<thead>
									<tr>
							...
							<div class="tab-pane fade" id="tidak-aktif" role="tabpanel" aria-labelledby="tidak-aktif-tab">
								<table id="tabel-par-tdk-aktif" class="table table-striped dataTable nowrap table-responsive-lg">
									<thead>
									<tr>
										<th class="text-center" style="width: 5%">No</th>
										<th>Nama</th>
