			...
			<div class="col-sm-12">
				<div class="card">
					...
					<div class="card-body">
						...
						<table class="table table-hover dataTable nowrap table-responsive-xl" id="lihat-log-mhs">
							<thead>
							<tr>
								<th width="10%">No</th>
								<th>Mahasiswa</th>
							...
							<tr>
								...
								<td class="sorting_1">
									<div class="d-inline-block align-middle">
										<img src="<?= base_url() ?>assets/magang/userfiles/<?= $b['foto_mhs'] ?>"
								...
								<td class="text-center">
									<a class="btn btn-sm btn-primary has-ripple" href="<?= site_url('magang/supervisor/detail_log_mahasiswa') ?>/<?= $b['idm'] ?>">
