				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="collapse" id="form-kirim">
							<form action="<?= site_url('magang/supervisor/kirim') ?>" id="pesan-mitra" method="post">
								<table class="table-borderless">
									...
									<tr>
										...
										<td>: &nbsp;</td>
										<td>
										<textarea name="pesan" id="isi_pesan" cols="30" rows="10"
							...
							<?php }else{ ?>
								...
								foreach ($list_pesan->result_array() as $p) : ?>
									<tr>
										...
										<td class="text-center"><?= tgl_jam_indo($p['tgl']) ?></td>
										<td>
											<a class="btn btn-sm btn-primary" href="<?= site_url('magang/supervisor/detail_pesan') ?>/<?= $p['id_p'] ?>">Lihat</a>
										</td>
									</tr>
								<?php endforeach; ?>
							<?php } ?>
